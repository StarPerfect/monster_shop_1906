...
RSpec.describe 'Merchant Admin can CRUD items' do
  it 'merchant admin can deactivate an active item then reactivate' do
    ...
    store_admin = User.create(name: "Billy Joel", address: "123 Billy Street", city: "Denver", state: "CO", zip: "80011", email:"billobillgmail.com", password: "yours", role: 1,  merchant_id: bike_city.id )
