...
billy.addresses << Address.create(nickname: 'home', street: "123 Billy Street", city: "Denver", state: "CO", zip: "80011")
corina = User.create(name: 'Corina Allen', email: 'StarPerfect@gmail.com', password: 'Hello123', role: 2, merchant_id: bike_shop.id)
corina.addresses << Address.create(nickname: 'home', street: '1488 S. Kenton', city: 'Aurora', state: 'CO', zip:'80014')
kate = User.create(name: "Kate Long", email:"kateaswesome@gmail.com", password: "ours", role: 2, merchant_id: dog_shop.id )
kate.addresses << Address.create(nickname: 'home', street: "123 Kate Street", city: "Fort Collins", state: "CO", zip: "80011")
santiago = User.create(name:"Santiago", email:"santamonica@hotmail.com", password: "everyone", role: 3)
santiago.addresses << Address.create(nickname: 'home', street: "123 tree st", city:"lakewood", state:"CO", zip: "19283")
scott = User.create(name: "Scott Payton", email:"bigfun@gmail.com", password: "mine", role: 0)
scott.addresses << Address.create(nickname: 'home', street: "123 Scott Street", city: "Stapleton", state: "CO", zip: "80011")
admin = User.create(name:"Administrator", email: "admin_boss@gmail.com", password: "admin", role: 3)
admin.addresses << Address.create(nickname: 'home', street: "123 tree st", city:"lakewood", state:"CO", zip: "19283")
reg_user = User.create(name: 'Reg Dude', email: 'regdude@gmail.com', password: 'fuckingproject')
reg_user.addresses << Address.create(nickname: 'home', street: '567 boring lane', city: 'Denver', state: 'CO', zip: '80204')
employee_user = User.create(name: 'Worker Bee', email: 'workerbee@gmail.com', password: 'honey', role: 1)
employee_user.addresses << Address.create(nickname: 'home', street: '1111 Hive Drive', city: 'Denver', state: 'CO', zip: '80204')
merchant_owner = User.create(name: 'Queen Bee', email: 'beyonce@gmail.com', password: 'queenb', role: 2)
merchant_owner.addresses << Address.create(nickname: 'home', street: '1111 Hive Drive', city: 'Denver', state: 'CO', zip: '80204')
