...
billy.addresses.build(nickname: 'home', street: "123 Billy Street", city: "Denver", state: "CO", zip: "80011")
corina = User.create(name: 'Corina Allen', email: 'StarPerfect@gmail.com', password: 'Hello123', role: 2, merchant_id: bike_shop.id)
corina.addresses.build(nickname: 'home', street: '1488 S. Kenton', city: 'Aurora', state: 'CO', zip:'80014')
kate = User.create(name: "Kate Long", email:"kateaswesome@gmail.com", password: "ours", role: 2, merchant_id: dog_shop.id )
kate.addresses.build(nickname: 'home', street: "123 Kate Street", city: "Fort Collins", state: "CO", zip: "80011")
...
scott.addresses.build(nickname: 'home', street: "123 Scott Street", city: "Stapleton", state: "CO", zip: "80011")
...
reg_user.addresses.build(nickname: 'home', street: '567 boring lane', city: 'Denver', state: 'CO', zip: '80204')
employee_user = User.create(name: 'Worker Bee', email: 'workerbee@gmail.com', password: 'honey', role: 1)
employee_user.addresses.build(nickname: 'home', street: '1111 Hive Drive', city: 'Denver', state: 'CO', zip: '80204')
merchant_owner = User.create(name: 'Queen Bee', email: 'beyonce@gmail.com', password: 'queenb', role: 2)
merchant_owner.addresses.build(nickname: 'home', street: '1111 Hive Drive', city: 'Denver', state: 'CO', zip: '80204')
